    ...
    <div name="contact" className="w-full h-screen bg-gradient-to-b from-black to-gray-800 p-4 text-white">
        <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
            ...
            <div className='flex justify-center'>
                <form action="https://getform.io/f/2aa30e29-554b-4fac-8436-e27ca4371194" method='POST' className='flex flex-col w-full md:w-1/2'>
                    ...
                    <input type="text" name="email" placeholder="email" className="p-2 my-4 bg-transparent border-2 rounded-md text-white focus:outline-none"/>
